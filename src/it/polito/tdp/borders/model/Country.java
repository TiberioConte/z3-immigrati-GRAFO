...
public class Country implements Comparable<Country>{
	...
	private int NumeroPersoneInstanziate;
	...
	public void setStatiConfinanti(int statiConfinanti) {
		StatiConfinanti = statiConfinanti;
	}
	
	

	public int getNumeroPersoneInstanziate() {
		return NumeroPersoneInstanziate;
	}

	public void setNumeroPersoneInstanziate(int numeroPersoneInstanziate) {
		NumeroPersoneInstanziate = numeroPersoneInstanziate;
	}
	...
	public int compareTo(Country o) {
		...
		return o.getStatiConfinanti()-this.getStatiConfinanti();
	}
